...
metricsBob = local_build_metric_table( ...
    methods, "bob", bobBudget.txPowerDb, bobEbN0dB, berBob, payloadBob, ...
...
if isfield(results, "eve")
    ...
    metricsEve = local_build_metric_table( ...
        methods, "eve", eveBudget.txPowerDb, eveEbN0dB, berEve, payloadEve, ...
...
t = table( ...
    ...
    wardenEbN0dB, ...
    'VariableNames', { ...
        'pointIndex', 'txPowerDb', 'bobEbN0dB', ...
...
function t = local_build_metric_table(methods, roleName, txPowerDb, ebN0dB, ber, payloadSuccessRate, commMetrics, compMetrics, frontEndSuccessRate, headerSuccessRate)
nMethods = numel(methods);
...
t = table( ...
    ...
    compSsimVec, ...
    'VariableNames', { ...
        'role', 'methodIndex', 'method', 'pointIndex', 'txPowerDb', 'ebN0dB', ...
...
local_require_fields(budgetIn, ["txPowerDb" "ebN0dB"], structName);
budget = struct();
