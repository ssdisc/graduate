...
p.mitigation.binding.impulseMethods = ["none" "blanking" "clipping" "ml_blanking" "ml_cnn"  "adaptive_ml_frontend"];
p.mitigation.binding.singleToneMethods = ["none" "fft_notch" "adaptive_notch" "adaptive_ml_frontend"];
p.mitigation.binding.narrowbandMethods = ["none" "fh_erasure" "ml_fh_erasure" "adaptive_ml_frontend"];
