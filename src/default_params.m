...
p.frame.phyHeaderDiversity.enable = false;  % 发送多份完整PHY头，在不同频点逐份解码，抗窄带/瑞利擦除
...
p.scFde = struct();
p.scFde.enable = false;              % payload按每跳做单载波频域均衡块
...
p.rxSync.multipathEq.compareMethods = ["none" "mmse" "zf" "ml_ridge" "sc_fde_mmse"];
