...
p.mitigation.fhErasure.freqConstellationMseRatioThreshold = 1.25; % 频点MSE相对全局中位数的门限
p.mitigation.fhErasure.freqConstellationMseFloor = 0.08;    % 频点级MSE绝对下限，避免低误差噪声抖动误触发
